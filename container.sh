...
function display_banner() {
	...
	echo
	echo "Machine Learning Toolbox for 'Machine Learning Specialization'"
	echo "version 0.1, Copyright (C) 2016 Gregory D. Horne"
	echo
	echo "Machine Learning Toolbox comes with ABSOLUTELY NO WARRANTY;"
	echo "for details read the LICENSE file."
	echo "This is free software, and you are welcome to redistribute it"
	echo "under certain conditions; read the LICENSE for details."
	echo
	echo "Further informmation about the Machine Learning Specialization"
	...
	echo -e "\t\thttps://www.coursera.org/specializations/machine-learning"
	echo -e "\n\tCoursera\n\t\thttps://coursera.org"
	echo
	...
	echo "provided as a convenience to participants in the Machine Learning"
	echo "Specalization."
	echo
	echo
}
